...
if __name__ == "__main__":
  ...
  p1 = Process(target=sumale100_2, args=(numeros_compartidos,candado))
  p2 = Process(target=sumale100_2, args=(numeros_compartidos,candado))
  p1.start()
  p2.start()
  p1.join()
  p2.join()
  print("Al final vale = ", numeros_compartidos.value)
